...
python train.py -i "SR_training_datasets\BSDS200" -o "B200lils.p" -li -ls -l 0.1
python train.py -i "SR_training_datasets\BSDS200" -o "B200Exlils.p" -li -ls -e -l 0.1
python train.py -i "SR_training_datasets\BSDS200" -o "B200culs.p" -cu -ls -l 0.1
python train.py -i "SR_training_datasets\BSDS200" -o "B200Exculs.p" -cu -ls -e -l 0.1

python train.py -i "SR_training_datasets\G100" -o "G100Ex.p" -li -cgls -e

python test.py -f "B200li.p" -i "SR_testing_datasets\Set14" -o "B200li_Set14" -gt -li
python test.py -f "B200cu.p" -i "SR_testing_datasets\Set14" -o "B200cu_Set14" -gt -cu
...
python psnr.py -gt "SR_testing_datasets\Set14" -sr "results\B200li_Set14"
